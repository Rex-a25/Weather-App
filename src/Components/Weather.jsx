...
const Weather = () => {
  ...
  const getCurrentHourIndex = () => {
    if (!weatherData?.current_weather?.time || !weatherData?.hourly?.time) return 0;
  ...
  return (
    <div className="min-h-screen bg-[#0a0a2a] p-8 text-white flex flex-col md:flex-row gap-8">
      ...
      {/* Hourly Forecast */}
      <div className="w-full md:w-72 bg-[#1a1a3d] rounded-xl p-6 shadow-lg h-fit">
